            ...
            then((querySnapshot) => {
                querySnapshot.forEach(doc => {
                    ...
                    if (doc.data().Rol == "Administrador" || doc.data().Rol == "SuperAdmin") {
                        ...
                        var contadorAdmin = 0
                        var contadorUser = 0
                        var contadorCajero = 0

                        var valueAdmin = document.querySelector('.valueAdmin')
                        var valueCajero = document.querySelector('.valueCajero')
                        var valueUser = document.querySelector('.valueUser')
                        ...
                        getDocs(query(collection(db, "Users", "IdUser", "Private_Data"))).
                            then(querySnapshot => {
                                querySnapshot.forEach(doc => {
                                    ...
                                    valueAdmin.textContent = contadorAdmin
                                    valueCajero.textContent = contadorCajero
                                    valueUser.textContent = contadorUser
                                })
                            })
