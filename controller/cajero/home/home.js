                    ...
                    if (doc.data().Rol == "Cajero") {
                        ...
                        onAuthStateChanged(auth, (user) => {
                            if (user) {
                                ...
                                var addVenta = document.querySelector('#addVenta')

                                var modalMenu = document.querySelector('.modalMenu')
                                var closeMenu = document.querySelector('.modalMenu i')
                                var closeMenu2 = document.querySelector('#closeMenu2')

                                var modalNumber = document.querySelector('.modalNumber')
                                var numbers = document.querySelectorAll('.modalNumber p')

                                var totalPedido = document.querySelector('.totalPedido')

                                var producto = document.querySelectorAll('.pro')

                                addVenta.addEventListener('click', () => {
                                    modalMenu.classList.add('active')
                                    closeMenu.addEventListener('click', () => {
                                        modalMenu.classList.remove('active')
                                        totalPedido.classList.remove('active')
                                    })
                                    ...
                                    numbers.forEach(number => {
                                        number.addEventListener('click', () => {
                                            modalNumber.classList.remove('active')
                                            totalPedido.classList.add('active')
                                        })
                                    })
                                })
